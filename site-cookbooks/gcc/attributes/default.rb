default['gcc_list'] = [
  {
    'source' => 'http://ftp.tsukuba.wide.ad.jp/software/gcc/releases/gcc-5.2.0/',
    'file' => 'gcc-5.2.0.tar.gz',
    'build_dir' => 'gcc-5.2.0',
    ...
    'source' => 'http://ftp.tsukuba.wide.ad.jp/software/gcc/releases/gcc-5.1.0/',
    'file' => 'gcc-5.1.0.tar.gz',
    'build_dir' => 'gcc-5.1.0',
    'prefix' => '/usr/local/gcc-5.1.0',
    'flags' => '--enable-languages=c,c++ --enable-lto --disable-multilib --without-ppl --without-cloog-ppl --enable-checking=release --disable-nls',
  },{
    'source' => 'http://ftp.tsukuba.wide.ad.jp/software/gcc/releases/gcc-4.9.2/',
    'file' => 'gcc-4.9.2.tar.gz',
    'build_dir' => 'gcc-4.9.2',
    ...
    'build_dir' => 'gcc-4.9.0',
    'prefix' => '/usr/local/gcc-4.9.0',
    'flags' => '--enable-languages=c,c++ --enable-lto --disable-multilib --without-ppl --without-cloog-ppl --enable-checking=release --disable-nls',
  },{
    'source' => 'http://ftp.tsukuba.wide.ad.jp/software/gcc/releases/gcc-4.8.2/',
    'file' => 'gcc-4.8.2.tar.gz',
    'build_dir' => 'gcc-4.8.2',
